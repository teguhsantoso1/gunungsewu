...
class App extends MY_Controller {
	...
	function export(){
		...
		$active_sheet->setCellValue('BF1', 'Q56');
		$active_sheet->setCellValue('BG1', 'Q57');
		$active_sheet->setCellValue('BH1', 'Q58');
		$active_sheet->setCellValue('BI1', 'Q59');
		$active_sheet->setCellValue('BJ1', 'Q60');		
		$active_sheet->setCellValue('BK1', 'Q61');
		$active_sheet->setCellValue('BL1', 'Q62');
		$active_sheet->setCellValue('BM1', 'Q63');
		$active_sheet->setCellValue('BN1', 'Kategori 1');
		$active_sheet->setCellValue('BO1', 'Open-Ended 1');
		$active_sheet->setCellValue('BP1', 'Ketegori 2');
		$active_sheet->setCellValue('BQ1', 'Open-Ended 2');
		$active_sheet->setCellValue('BR1', 'Audit');
		$active_sheet->setCellValue('BS1', 'Salah');
		$active_sheet->setCellValue('BT1', 'User Entry');
		$active_sheet->setCellValue('BU1', 'Date Entry');
		$active_sheet->setCellValue('BV1', 'Code');
		...
		foreach($result as $r){
			...
			$active_sheet->setCellValue('BF'.$i, $quesioner[56-1]);
			$active_sheet->setCellValue('BG'.$i, $quesioner[57-1]);
			$active_sheet->setCellValue('BH'.$i, $quesioner[58-1]);
			$active_sheet->setCellValue('BI'.$i, $quesioner[59-1]);
			$active_sheet->setCellValue('BJ'.$i, $quesioner[60-1]);
			$active_sheet->setCellValue('BK'.$i, $quesioner[61-1]);
			$active_sheet->setCellValue('BL'.$i, $quesioner[62-1]);
			$active_sheet->setCellValue('BM'.$i, $quesioner[63-1]);
			$active_sheet->setCellValue('BN'.$i, $r->bidang_1_name);
			$active_sheet->setCellValue('BO'.$i, $r->bidang_1_ket);
			$active_sheet->setCellValue('BP'.$i, $r->bidang_2_name);
			$active_sheet->setCellValue('BQ'.$i, $r->bidang_2_ket);
			$active_sheet->setCellValue('BR'.$i, $r->audit);
			$active_sheet->setCellValue('BS'.$i, $r->salah);
			$active_sheet->setCellValue('BT'.$i, $r->fullname);
			$active_sheet->setCellValue('BU'.$i, PHPExcel_Shared_Date::PHPToExcel(date_to_excel($r->date_create)));
			$active_sheet->getStyle('BU'.$i)->getNumberFormat()->setFormatCode('dd/mm/yyyy');		   
			$active_sheet->setCellValue('BV'.$i, $r->code);
			$i++;
		}
